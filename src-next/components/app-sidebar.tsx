  ...
  return (
    <Sidebar collapsible="icon" {...props}>
      <SidebarHeader>
        <a
          href="/dashboard"
          className="flex items-center gap-2 px-4 py-2 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:px-0"
        >
          ...
          {showLogo ? (
            <img
              src={settings.logo!}
              alt="Logo"
              className="size-5 shrink-0 rounded group-data-[collapsible=icon]:flex hidden object-contain"
            />
          ) : (
            <svg
              className="size-5 shrink-0 group-data-[collapsible=icon]:flex hidden"
              viewBox="0 0 28 28"
              fill="none"
