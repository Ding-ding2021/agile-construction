const TaskSidebar = () => {
  ...
  const navItems = [
    ...
    { icon: '35.svg', label: '客户管理', href: '#/customers' },
    { icon: '36.svg', label: '合同结算', href: '#/contracts' },
    { icon: '37.svg', label: '采购管理', href: '#/procurement' },
    { icon: '38.svg', label: '订单管理', href: '#/orders' },
    { icon: '39.svg', label: '设施管理', href: '#/facility' },
    { icon: '40.svg', label: '标准管理', href: '#/standards' },
    { icon: '41.svg', label: '人员管理', href: '#/personnel' },
    { icon: '42.svg', label: '数字员工', href: '#/digital-employee' },
    { icon: '43.svg', label: '系统设置', href: '#/settings' },
  ];
