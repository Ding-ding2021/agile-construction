      ...
      <div className="tm-workspace">
        <main className="tm-main">
          ...
          <div className="tm-body">
            <StatsCards
              items={[
                { key: 'all', icon: '1.svg', label: '全部任务数', value: stats.total, tone: 'blue' },
                { key: 'pendingAssign', icon: '3.svg', label: '待分配数', value: stats.pendingAssign, tone: 'blue' },
                { key: 'executing', icon: '5.svg', label: '执行中数', value: stats.executing, tone: 'blue' },
                { key: 'pendingSubmit', icon: '7.svg', label: '待提交数', value: stats.pendingSubmit, tone: 'orange' },
                { key: 'pendingAcceptance', icon: '1.svg', label: '待验收数', value: stats.pendingAcceptance, tone: 'orange' },
                { key: 'slaRisk', icon: '3.svg', label: '超时/即将超时数', value: stats.slaWarningOrOverdue, tone: 'red' },
                { key: 'blocked', icon: '5.svg', label: '阻塞任务数', value: stats.blocked, tone: 'red' },
              ]}
              ...
              <TaskListView
                ...
                onOpenTaskDetail={(taskCode) => {
                  if (typeof window !== 'undefined') {
                    window.location.hash = `#/tasks/${encodeURIComponent(taskCode)}`;
                  }
                }}
              />
            </section>
