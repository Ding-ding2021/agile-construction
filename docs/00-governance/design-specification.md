...
**更新日期**: 2026-04-16  
**维护团队**: AI Agent  
**最后校验基线**: `src/index.css`（`--pm-*` 变量体系）  
**总览文档**: [`../../DESIGN_SPECIFICATION.md`](../../DESIGN_SPECIFICATION.md)
...
| 变量名               | 色值      | 用途                         |
| -------------------- | --------- | ---------------------------- |
| `--pm-primary`       | `#154DD9` | 主按钮、导航选中态、重点强调 |
| `--pm-primary-light` | `#1a5ae8` | 主色悬停态                   |
| `--pm-primary-dark`  | `#1248c5` | 主色按下态                   |
...
| 变量名              | 色值      | 用途           |
| ------------------- | --------- | -------------- |
| `--pm-blue`         | `#2B7FFF` | 信息、链接     |
| `--pm-blue-light`   | `#51A2FF` | 信息悬停态     |
| `--pm-green`        | `#00BC7D` | 成功、进行中   |
| `--pm-green-light`  | `#00D492` | 成功悬停态     |
| `--pm-purple`       | `#8E51FF` | 特殊标记       |
| `--pm-purple-light` | `#A684FF` | 特殊标记悬停态 |
...
# 打开特定设计稿
open .codebuddy/figma/374_2/figma.html

# 查看设计稿截图
open .codebuddy/figma/374_2/screenShot.png
```
