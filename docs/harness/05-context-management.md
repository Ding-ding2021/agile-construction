...
会话启动
    │
    ▼
1. opencode.json → instructions: ["AGENTS.md", "docs/harness/roles/{role}.md"]
    │
    ▼
2. AGENTS.md ── 全局：角色/工作流/规则/反作弊
    ...
    ▼
3. 角色说明卡 ── 本角色专属
    ├── docs/harness/roles/产品.md (26 技能 + 14 指标)
    ├── docs/harness/roles/设计.md (33 技能 + 12 指标)
    ├── docs/harness/roles/开发.md (30 技能 + 13 指标)
    └── docs/harness/roles/测试.md (12 技能 + 12 指标)
    │
    ▼
...
| **知识库用索引** | 不加载文档全文，只加载 docs/harness/04-knowledge-base.md 的索引 |
